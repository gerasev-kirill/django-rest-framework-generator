...
class Serializer(TestCase):
    ...
    def test_serializergen_with_django_model(self):
        ...
        self.assertEqual(
            opts.fields,
            ['auth_token', 'testmodelwithowner', 'id', 'password', 'last_login', 'is_superuser', 'username', 'first_name', 'last_name', 'email', 'is_staff', 'is_active', 'date_joined', 'groups', 'user_permissions']
        )
